namespace SkySpeedService.PNR
{
    class HTMLBody
    {
        ...
        public string GenerateHtml(string passengerName, string takeOff, string takeOffAirport, string landing, string landingAirport, string flightDuration, string flightNumber, string seat, string pnr)
        {
